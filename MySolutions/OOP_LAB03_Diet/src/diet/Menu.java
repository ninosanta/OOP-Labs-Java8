...
public class Menu implements NutritionalElement {
	...
	public void addRecipe(String recipe, double quantity) {
		double fact = quantity / 100;
		NutritionalElement ne;
		ne = food.getRecipe(recipe);
		
		calories += ne.getCalories()*fact;
		proteins += ne.getProteins()*fact;
		carbs += ne.getCarbs()*fact;
		fat += ne.getFat()*fact;
	}
